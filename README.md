...
This is the C# version. We also offer a [VB.NET version.](https://github.(mailto:sales@atalasoft.com)/AtalaSupport/DemoGallery_Desktop_ColorExtractionDemo_VB_x64)  
...
## Downloading source
The sources can be downloaded for [c#](https://github.(mailto:sales@atalasoft.com)/AtalaSupport/DemoGallery_Desktop_ColorExtractionDemo_CS_x64/archive/refs/heads/main.zip) and [VB.NET](https://github.(mailto:sales@atalasoft.com)/AtalaSupport/DemoGallery_Desktop_ColorExtractionDemo_VB_x64/archive/refs/heads/main.zip)
...
```bash
git clone https://github.(mailto:sales@atalasoft.com)/AtalaSupport/DemoGallery_Desktop_ColorExtractionDemo_CS_x64.git ColorExtractionDemo --recursive
